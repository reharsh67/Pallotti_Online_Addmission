                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <form id="form2" runat="server" role="form" method="post">
                                    ...
                                    <asp:TextBox ID="UserName" DataValueField="fname" class="form-control" runat="server" required ToolTip="Enter Your Name"></asp:TextBox>     <br />  
                                    <label>Mobile Number  <span class="required"><b>*</b></span></label>
                                     <asp:TextBox ID="MobNo" DataValueField="Mno" class="form-control" runat="server" required ToolTip="Enter MobNo"></asp:TextBox>    <br />
                                     ...
                                     <asp:TextBox ID="EMAIL" class="form-control"  DataValueField="EmailId" runat="server" required ToolTip="Enter Email"></asp:TextBox>
                                       ...
                                       <label>Write Your Query <span class="required"><b>*</b></span></label>
                                       <asp:TextBox ID="askQue" class="form-control"  DataValueField="question" runat="server" required ToolTip="Ask Query"></asp:TextBox>

                                    </div>
                                    <center>

                                         <asp:Button ID="Button1" runat="server" onclick="Button1_Click" class=" mu-post-btn"   Text="Post" >   </asp:Button>
                               </center> </form>
                            </div>
                        </div>
                    </div>
